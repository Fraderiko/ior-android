package ru.iorcontrol.ior.ior.Profile;
...
public class ProfileScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        third_switch = findViewById(R.id.third_switch);
        ...
        getUser.enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                ...
                third_switch.setChecked(user.new_chat_notification);
            }
    ...
    void updateProfile() {
        ...
        user.new_chat_notification = third_switch.isChecked();
